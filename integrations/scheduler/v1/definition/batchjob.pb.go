...
type BatchJobSpec struct {
	...
	Completions  *int32 `protobuf:"varint,3,opt,name=completions,proto3,oneof" json:"completions,omitempty"`
	BackoffLimit *int32 `protobuf:"varint,4,opt,name=backoff_limit,json=backoffLimit,proto3,oneof" json:"backoff_limit,omitempty"`
}
...
var file_integrations_scheduler_v1_definition_batchjob_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52, 0x0b, 0x63, 0x6f, 0x6d,
