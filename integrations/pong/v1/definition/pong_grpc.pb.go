...
func (c *pongV1Client) Ping(ctx context.Context, in *definition.Empty, opts ...grpc.CallOption) (*PongV1PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, PongV1_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pongV1Client) Services(ctx context.Context, in *definition.Empty, opts ...grpc.CallOption) (*PongV1ServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, PongV1_Services_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPongV1Server must be embedded to have
...
func (UnimplementedPongV1Server) testEmbeddedByValue()                {}
...
func RegisterPongV1Server(s grpc.ServiceRegistrar, srv PongV1Server) {
	// If the following call pancis, it indicates UnimplementedPongV1Server was
...
func _PongV1_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PongV1_Ping_FullMethodName,
	}
...
func _PongV1_Services_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PongV1_Services_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
