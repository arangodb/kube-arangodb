...
Flags:
  ...
  -h, --help                                                                                help for arangodb_operator_integration
      ...
      --integration.connector.v1                                                            ConnectorV1 Integration (Env: INTEGRATION_CONNECTOR_V1)
      --integration.connector.v1.connector-id string                                        Connector UUID (Env: INTEGRATION_CONNECTOR_V1_CONNECTOR_ID)
      --integration.connector.v1.external                                                   Defines if External access to service connector.v1 is enabled (Env: INTEGRATION_CONNECTOR_V1_EXTERNAL) (default true)
      --integration.connector.v1.internal                                                   Defines if Internal access to service connector.v1 is enabled (Env: INTEGRATION_CONNECTOR_V1_INTERNAL) (default true)
      --integration.connector.v1.internal-address string                                    Internal gRPC address for MetaV1 and StorageV2 clients (Env: INTEGRATION_CONNECTOR_V1_INTERNAL_ADDRESS) (default "127.0.0.1:9092")
