...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.5/pkg/apis/platform/v1beta1/link_spec.go#L48)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.5/pkg/apis/platform/v1beta1/link_spec.go#L45)</sup>
