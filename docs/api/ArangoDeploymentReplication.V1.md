...
Type: `boolean` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/replication_spec.go#L38)</sup>
...
Type: `boolean` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/replication_spec.go#L41)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/endpoint_authentication_spec.go#L37)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/endpoint_authentication_spec.go#L42)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/endpoint_spec.go#L36)</sup>
...
Type: `array` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/endpoint_spec.go#L42)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.1/pkg/apis/replication/v1/endpoint_tls_spec.go#L34)</sup>
