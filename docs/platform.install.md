...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L83)</sup>
...
Type: `Object` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L87)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L70)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L73)</sup>
...
Type: `Object` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L167)</sup>
...
Type: `string` <sup>[\[ref\]](https://github.com/arangodb/kube-arangodb/blob/1.4.0/pkg/util/k8sutil/helm/package.go#L163)</sup>
