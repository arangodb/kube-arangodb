...
- (Feature) (Chart) Add the arango-deployment Helm chart that renders an ArangoDeployment (Single, Cluster or ActiveFailover) with schema-validated values for the common use-cases and a deep-merged spec override
