...
|:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |
| ArangoPlatform OpenID SSO | 1.2.48 | 1.2.48 | >= 3.8.0 | Community, Enterprise | Beta | True | N/A | Support for ArangoPlatform SSO with OpenID |
| Support for ArangoPlatform SSO with OpenID | 1.2.48 | 1.2.48 | >= 3.8.0 | Community, Enterprise | Beta | True | N/A | Support for ArangoDeployment Gateway Group |
| ArangoPlatform | 1.2.48 | 1.2.43 | >= 3.8.0 | Community, Enterprise | Beta | True | N/A | ArangoPlatform Solution with support for ArangoDeployment Gateway Group |
