...
func (a *implementation) APIListPolicy(ctx context.Context, request *pbSharedV1.OffsetRequest) (*sidecarSvcAuthzDefinition.AuthorizationAPIListResponse, error) {
	...
	if err := authenticator.GetIdentity(ctx).EvaluatePermission(ctx, a.Plugin(), "rbac:ListPolicy", ""); err != nil {
		return nil, err
	}
...
func (a *implementation) APIDeletePolicy(ctx context.Context, request *sidecarSvcAuthzDefinition.AuthorizationAPINamedRequest) (*sidecarSvcAuthzDefinition.AuthorizationAPIPolicyResponse, error) {
	...
	if err := authenticator.GetIdentity(ctx).EvaluatePermission(ctx, a.Plugin(), "rbac:DeletePolicy", request.GetName()); err != nil {
		return nil, err
	}
...
func (a *implementation) APICreatePolicy(ctx context.Context, request *sidecarSvcAuthzDefinition.AuthorizationAPIPolicyRequest) (*sidecarSvcAuthzDefinition.AuthorizationAPIPolicyResponse, error) {
	...
	if err := authenticator.GetIdentity(ctx).EvaluatePermission(ctx, a.Plugin(), "rbac:CreatePolicy", request.GetName()); err != nil {
		return nil, err
	}
...
func (a *implementation) APIUpdatePolicy(ctx context.Context, request *sidecarSvcAuthzDefinition.AuthorizationAPIPolicyRequest) (*sidecarSvcAuthzDefinition.AuthorizationAPIPolicyResponse, error) {
	...
	if err := authenticator.GetIdentity(ctx).EvaluatePermission(ctx, a.Plugin(), "rbac:UpdatePolicy", request.GetName()); err != nil {
		return nil, err
	}
