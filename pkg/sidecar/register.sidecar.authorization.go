...
import (
	...
	sidecarSvcAuthzImpl "github.com/arangodb/kube-arangodb/pkg/sidecar/services/authorization"
...
func registerAuthorization(cmd *cobra.Command) (svc.Handler, bool, error) {
	...
	return sidecarSvcAuthzImpl.NewAuthorizer(db.NewClient(client).Database("_system")), true, nil
}
