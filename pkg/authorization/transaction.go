...
type TransactionFunc[T proto.Message] func(ctx context.Context, c arangodb.Transaction) (T, error)

func WithTransaction[T proto.Message](ctx context.Context, db arangodb.Database, cols arangodb.TransactionCollections, opts *arangodb.BeginTransactionOptions, process TransactionFunc[T]) (T, error) {
	if opts == nil {
