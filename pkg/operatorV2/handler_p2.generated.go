...
type HandleP2ConditionExtract[P1, P2 any] func(ctx context.Context, p1 P1, p2 P2) *sharedApi.ConditionList
...
func HandleP2WithCondition[P1, P2 any](ctx context.Context, conditions *sharedApi.ConditionList, condition sharedApi.ConditionType, p1 P1, p2 P2, handler ...HandleP2Func[P1, P2]) (bool, error) {
	changed, err := HandleP2[P1, P2](ctx, p1, p2, handler...)
	return WithCondition(conditions, condition, changed, err)
}

func HandleP2Condition[P1, P2 any](extract HandleP2ConditionExtract[P1, P2], condition sharedApi.ConditionType, handler HandleP2ConditionFunc[P1, P2]) HandleP2Func[P1, P2] {
