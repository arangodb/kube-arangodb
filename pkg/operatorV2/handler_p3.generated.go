...
type HandleP3ConditionExtract[P1, P2, P3 any] func(ctx context.Context, p1 P1, p2 P2, p3 P3) *sharedApi.ConditionList
...
func HandleP3WithCondition[P1, P2, P3 any](ctx context.Context, conditions *sharedApi.ConditionList, condition sharedApi.ConditionType, p1 P1, p2 P2, p3 P3, handler ...HandleP3Func[P1, P2, P3]) (bool, error) {
	changed, err := HandleP3[P1, P2, P3](ctx, p1, p2, p3, handler...)
	return WithCondition(conditions, condition, changed, err)
}

func HandleP3Condition[P1, P2, P3 any](extract HandleP3ConditionExtract[P1, P2, P3], condition sharedApi.ConditionType, handler HandleP3ConditionFunc[P1, P2, P3]) HandleP3Func[P1, P2, P3] {
