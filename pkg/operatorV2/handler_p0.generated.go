...
type HandleP0ConditionExtract func(ctx context.Context) *sharedApi.ConditionList
...
func HandleP0WithCondition(ctx context.Context, conditions *sharedApi.ConditionList, condition sharedApi.ConditionType, handler ...HandleP0Func) (bool, error) {
	changed, err := HandleP0(ctx, handler...)
	return WithCondition(conditions, condition, changed, err)
}

func HandleP0Condition(extract HandleP0ConditionExtract, condition sharedApi.ConditionType, handler HandleP0ConditionFunc) HandleP0Func {
