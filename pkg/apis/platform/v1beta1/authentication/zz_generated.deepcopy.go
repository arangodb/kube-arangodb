...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ALBClaims) DeepCopyInto(out *ALBClaims) {
	*out = *in
	if in.Username != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ALBClaims.
func (in *ALBClaims) DeepCopy() *ALBClaims {
	if in == nil {
		return nil
	}
	out := new(ALBClaims)
