...
type ArangoPlatformWorkflowSpecUpgrade struct {
...
func (c *ArangoPlatformWorkflowSpecUpgrade) GetTimeout() time.Duration {
...
func (c *ArangoPlatformWorkflowSpecUpgrade) GetMaxHistory() int {
...
func (c *ArangoPlatformWorkflowSpecUpgrade) Validate() error {
	if c == nil {
		return nil
	}
