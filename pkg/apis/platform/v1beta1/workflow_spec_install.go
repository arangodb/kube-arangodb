...
type ArangoPlatformWorkflowSpecInstall struct {
	// Timeout defines the install timeout
	// +doc/default: 20m
	Timeout *meta.Duration `json:"timeout,omitempty"`
}

func (c *ArangoPlatformWorkflowSpecInstall) GetTimeout() time.Duration {
...
func (c *ArangoPlatformWorkflowSpecInstall) Validate() error {
	if c == nil {
		return nil
	}
