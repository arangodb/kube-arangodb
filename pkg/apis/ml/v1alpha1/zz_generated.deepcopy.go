...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArangoMLExtensionTemplateSpec) DeepCopyInto(out *ArangoMLExtensionTemplateSpec) {
	*out = *in
	if in.PodTemplate != nil {
		in, out := &in.PodTemplate, &out.PodTemplate
		*out = new(sharedv1.PodTemplate)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArangoMLExtensionTemplateSpec.
func (in *ArangoMLExtensionTemplateSpec) DeepCopy() *ArangoMLExtensionTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(ArangoMLExtensionTemplateSpec)
