...
type ArangoPermissionRoleUserBindingStatus struct {
	...
	// UserRoleBinding keeps the UserRoleBinding Reference
	UserRoleBinding *sharedApi.Object `json:"userRoleBinding,omitempty"`
}
