...
type ServerGroupSpec struct {
	...
	// +doc/important: Values set by this feature overrides user-provided `ARANGODB_OVERRIDE_DETECTED_TOTAL_MEMORY` Container Environment Variable
	// +doc/default: true
	// +doc/link: Docs of the ArangoDB Envs|https://docs.arangodb.com/3.11/components/arangodb-server/environment-variables/
	...
	// +doc/important: Values set by this feature overrides user-provided `ARANGODB_OVERRIDE_DETECTED_NUMBER_OF_CORES` Container Environment Variable
	// +doc/default: true
	// +doc/link: Docs of the ArangoDB Envs|https://docs.arangodb.com/3.11/components/arangodb-server/environment-variables/
