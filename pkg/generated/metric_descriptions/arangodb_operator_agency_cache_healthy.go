...
func ArangodbOperatorAgencyCacheHealthyGauge(value float64, namespace string, name string) metrics.Metric {
	return ArangodbOperatorAgencyCacheHealthy().Gauge(value, namespace, name)
}
