...
type ArangoClusterSynchronizationLister interface {
	...
	List(selector labels.Selector) (ret []*deploymentv2alpha1.ArangoClusterSynchronization, err error)
...
type arangoClusterSynchronizationLister struct {
	listers.ResourceIndexer[*deploymentv2alpha1.ArangoClusterSynchronization]
}
...
func NewArangoClusterSynchronizationLister(indexer cache.Indexer) ArangoClusterSynchronizationLister {
	return &arangoClusterSynchronizationLister{listers.New[*deploymentv2alpha1.ArangoClusterSynchronization](indexer, deploymentv2alpha1.Resource("arangoclustersynchronization"))}
}
...
func (s *arangoClusterSynchronizationLister) ArangoClusterSynchronizations(namespace string) ArangoClusterSynchronizationNamespaceLister {
	return arangoClusterSynchronizationNamespaceLister{listers.NewNamespaced[*deploymentv2alpha1.ArangoClusterSynchronization](s.ResourceIndexer, namespace)}
}
...
type ArangoClusterSynchronizationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*deploymentv2alpha1.ArangoClusterSynchronization, error)
