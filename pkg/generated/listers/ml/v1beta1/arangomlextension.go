...
type ArangoMLExtensionLister interface {
	...
	List(selector labels.Selector) (ret []*mlv1beta1.ArangoMLExtension, err error)
...
func NewArangoMLExtensionLister(indexer cache.Indexer) ArangoMLExtensionLister {
	return &arangoMLExtensionLister{listers.New[*mlv1beta1.ArangoMLExtension](indexer, mlv1beta1.Resource("arangomlextension"))}
}

// ArangoMLExtensions returns an object that can list and get ArangoMLExtensions.
func (s *arangoMLExtensionLister) ArangoMLExtensions(namespace string) ArangoMLExtensionNamespaceLister {
	return arangoMLExtensionNamespaceLister{listers.NewNamespaced[*mlv1beta1.ArangoMLExtension](s.ResourceIndexer, namespace)}
}
...
type ArangoMLExtensionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*mlv1beta1.ArangoMLExtension, error)
