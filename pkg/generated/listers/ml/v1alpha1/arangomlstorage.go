...
type arangoMLStorageLister struct {
	listers.ResourceIndexer[*mlv1alpha1.ArangoMLStorage]
}
...
func NewArangoMLStorageLister(indexer cache.Indexer) ArangoMLStorageLister {
	return &arangoMLStorageLister{listers.New[*mlv1alpha1.ArangoMLStorage](indexer, mlv1alpha1.Resource("arangomlstorage"))}
}

// ArangoMLStorages returns an object that can list and get ArangoMLStorages.
func (s *arangoMLStorageLister) ArangoMLStorages(namespace string) ArangoMLStorageNamespaceLister {
	return arangoMLStorageNamespaceLister{listers.NewNamespaced[*mlv1alpha1.ArangoMLStorage](s.ResourceIndexer, namespace)}
}
