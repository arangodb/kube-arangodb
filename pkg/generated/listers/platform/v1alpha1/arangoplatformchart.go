...
type ArangoPlatformChartLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.ArangoPlatformChart, err error)
...
func NewArangoPlatformChartLister(indexer cache.Indexer) ArangoPlatformChartLister {
	return &arangoPlatformChartLister{listers.New[*v1alpha1.ArangoPlatformChart](indexer, v1alpha1.Resource("arangoplatformchart"))}
}

// ArangoPlatformCharts returns an object that can list and get ArangoPlatformCharts.
func (s *arangoPlatformChartLister) ArangoPlatformCharts(namespace string) ArangoPlatformChartNamespaceLister {
	return arangoPlatformChartNamespaceLister{listers.NewNamespaced[*v1alpha1.ArangoPlatformChart](s.ResourceIndexer, namespace)}
}
...
type ArangoPlatformChartNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.ArangoPlatformChart, error)
