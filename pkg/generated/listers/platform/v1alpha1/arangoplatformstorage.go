...
type ArangoPlatformStorageLister interface {
	...
	List(selector labels.Selector) (ret []*platformv1alpha1.ArangoPlatformStorage, err error)
...
type arangoPlatformStorageLister struct {
	listers.ResourceIndexer[*platformv1alpha1.ArangoPlatformStorage]
}
...
func NewArangoPlatformStorageLister(indexer cache.Indexer) ArangoPlatformStorageLister {
	return &arangoPlatformStorageLister{listers.New[*platformv1alpha1.ArangoPlatformStorage](indexer, platformv1alpha1.Resource("arangoplatformstorage"))}
}

// ArangoPlatformStorages returns an object that can list and get ArangoPlatformStorages.
func (s *arangoPlatformStorageLister) ArangoPlatformStorages(namespace string) ArangoPlatformStorageNamespaceLister {
	return arangoPlatformStorageNamespaceLister{listers.NewNamespaced[*platformv1alpha1.ArangoPlatformStorage](s.ResourceIndexer, namespace)}
}
...
type ArangoPlatformStorageNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*platformv1alpha1.ArangoPlatformStorage, error)
