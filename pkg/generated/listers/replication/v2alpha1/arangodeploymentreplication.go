...
type ArangoDeploymentReplicationLister interface {
	...
	List(selector labels.Selector) (ret []*replicationv2alpha1.ArangoDeploymentReplication, err error)
...
type arangoDeploymentReplicationLister struct {
	listers.ResourceIndexer[*replicationv2alpha1.ArangoDeploymentReplication]
}
...
func NewArangoDeploymentReplicationLister(indexer cache.Indexer) ArangoDeploymentReplicationLister {
	return &arangoDeploymentReplicationLister{listers.New[*replicationv2alpha1.ArangoDeploymentReplication](indexer, replicationv2alpha1.Resource("arangodeploymentreplication"))}
}
...
func (s *arangoDeploymentReplicationLister) ArangoDeploymentReplications(namespace string) ArangoDeploymentReplicationNamespaceLister {
	return arangoDeploymentReplicationNamespaceLister{listers.NewNamespaced[*replicationv2alpha1.ArangoDeploymentReplication](s.ResourceIndexer, namespace)}
}
...
type ArangoDeploymentReplicationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*replicationv2alpha1.ArangoDeploymentReplication, error)
