...
import (
	v1alpha "github.com/arangodb/kube-arangodb/pkg/apis/database/v1alpha"
...
type ArangoBackupLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha.ArangoBackup, err error)
...
// List lists all ArangoBackups in the indexer.
func (s *arangoBackupLister) List(selector labels.Selector) (ret []*v1alpha.ArangoBackup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha.ArangoBackup))
	})
	return ret, err
}
...
type ArangoBackupNamespaceLister interface {
	...
	Get(name string) (*v1alpha.ArangoBackup, error)
...
// List lists all ArangoBackups in the indexer for a given namespace.
func (s arangoBackupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha.ArangoBackup, err error) {
...
// Get retrieves the ArangoBackup from the indexer for a given namespace and name.
func (s arangoBackupNamespaceLister) Get(name string) (*v1alpha.ArangoBackup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha.Resource("arangobackup"), name)
	}
	return obj.(*v1alpha.ArangoBackup), nil
}
