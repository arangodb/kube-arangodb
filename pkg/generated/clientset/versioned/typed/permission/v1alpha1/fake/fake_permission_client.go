...
import (
	v1alpha1 "github.com/arangodb/kube-arangodb/pkg/generated/clientset/versioned/typed/permission/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakePermissionV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakePermissionV1alpha1) ArangoPermissionRoleGroupBindings(namespace string) v1alpha1.ArangoPermissionRoleGroupBindingInterface {
	return newFakeArangoPermissionRoleGroupBindings(c, namespace)
}
...
func (c *FakePermissionV1alpha1) RESTClient() rest.Interface {
