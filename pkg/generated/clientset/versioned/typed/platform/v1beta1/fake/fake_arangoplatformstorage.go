...
var arangoplatformstoragesResource = v1beta1.SchemeGroupVersion.WithResource("arangoplatformstorages")

var arangoplatformstoragesKind = v1beta1.SchemeGroupVersion.WithKind("ArangoPlatformStorage")
...
func (c *FakeArangoPlatformStorages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ArangoPlatformStorage, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorage{}
	obj, err := c.Fake.
	...
	return obj.(*v1beta1.ArangoPlatformStorage), err
}

// List takes label and field selectors, and returns the list of ArangoPlatformStorages that match those selectors.
func (c *FakeArangoPlatformStorages) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ArangoPlatformStorageList, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorageList{}
	obj, err := c.Fake.
	...
	list := &v1beta1.ArangoPlatformStorageList{ListMeta: obj.(*v1beta1.ArangoPlatformStorageList).ListMeta}
	for _, item := range obj.(*v1beta1.ArangoPlatformStorageList).Items {
...
func (c *FakeArangoPlatformStorages) Create(ctx context.Context, arangoPlatformStorage *v1beta1.ArangoPlatformStorage, opts v1.CreateOptions) (result *v1beta1.ArangoPlatformStorage, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorage{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformStorages) Update(ctx context.Context, arangoPlatformStorage *v1beta1.ArangoPlatformStorage, opts v1.UpdateOptions) (result *v1beta1.ArangoPlatformStorage, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorage{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformStorages) UpdateStatus(ctx context.Context, arangoPlatformStorage *v1beta1.ArangoPlatformStorage, opts v1.UpdateOptions) (result *v1beta1.ArangoPlatformStorage, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorage{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformStorages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(arangoplatformstoragesResource, c.ns, name, opts), &v1beta1.ArangoPlatformStorage{})
...
func (c *FakeArangoPlatformStorages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.ArangoPlatformStorageList{})
	return err
}

// Patch applies the patch and returns the patched arangoPlatformStorage.
func (c *FakeArangoPlatformStorages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ArangoPlatformStorage, err error) {
	emptyResult := &v1beta1.ArangoPlatformStorage{}
	obj, err := c.Fake.
