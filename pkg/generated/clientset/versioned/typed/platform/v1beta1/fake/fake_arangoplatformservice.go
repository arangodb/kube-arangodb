...
var arangoplatformservicesResource = v1beta1.SchemeGroupVersion.WithResource("arangoplatformservices")

var arangoplatformservicesKind = v1beta1.SchemeGroupVersion.WithKind("ArangoPlatformService")
...
func (c *FakeArangoPlatformServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ArangoPlatformService, err error) {
	emptyResult := &v1beta1.ArangoPlatformService{}
	obj, err := c.Fake.
	...
	return obj.(*v1beta1.ArangoPlatformService), err
}

// List takes label and field selectors, and returns the list of ArangoPlatformServices that match those selectors.
func (c *FakeArangoPlatformServices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ArangoPlatformServiceList, err error) {
	emptyResult := &v1beta1.ArangoPlatformServiceList{}
	obj, err := c.Fake.
	...
	list := &v1beta1.ArangoPlatformServiceList{ListMeta: obj.(*v1beta1.ArangoPlatformServiceList).ListMeta}
	for _, item := range obj.(*v1beta1.ArangoPlatformServiceList).Items {
...
func (c *FakeArangoPlatformServices) Create(ctx context.Context, arangoPlatformService *v1beta1.ArangoPlatformService, opts v1.CreateOptions) (result *v1beta1.ArangoPlatformService, err error) {
	emptyResult := &v1beta1.ArangoPlatformService{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformServices) Update(ctx context.Context, arangoPlatformService *v1beta1.ArangoPlatformService, opts v1.UpdateOptions) (result *v1beta1.ArangoPlatformService, err error) {
	emptyResult := &v1beta1.ArangoPlatformService{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformServices) UpdateStatus(ctx context.Context, arangoPlatformService *v1beta1.ArangoPlatformService, opts v1.UpdateOptions) (result *v1beta1.ArangoPlatformService, err error) {
	emptyResult := &v1beta1.ArangoPlatformService{}
	obj, err := c.Fake.
...
func (c *FakeArangoPlatformServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(arangoplatformservicesResource, c.ns, name, opts), &v1beta1.ArangoPlatformService{})
...
func (c *FakeArangoPlatformServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.ArangoPlatformServiceList{})
	return err
}

// Patch applies the patch and returns the patched arangoPlatformService.
func (c *FakeArangoPlatformServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ArangoPlatformService, err error) {
	emptyResult := &v1beta1.ArangoPlatformService{}
	obj, err := c.Fake.
