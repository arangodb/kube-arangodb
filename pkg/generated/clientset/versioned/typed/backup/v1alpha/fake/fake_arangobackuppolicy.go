...
func (c *FakeArangoBackupPolicies) Get(name string, options v1.GetOptions) (result *v1alpha.ArangoBackupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(arangobackuppoliciesResource, c.ns, name), &v1alpha.ArangoBackupPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.ArangoBackupPolicy), err
}

// List takes label and field selectors, and returns the list of ArangoBackupPolicies that match those selectors.
func (c *FakeArangoBackupPolicies) List(opts v1.ListOptions) (result *v1alpha.ArangoBackupPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(arangobackuppoliciesResource, arangobackuppoliciesKind, c.ns, opts), &v1alpha.ArangoBackupPolicyList{})
	...
	list := &v1alpha.ArangoBackupPolicyList{ListMeta: obj.(*v1alpha.ArangoBackupPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha.ArangoBackupPolicyList).Items {
...
func (c *FakeArangoBackupPolicies) Create(arangoBackupPolicy *v1alpha.ArangoBackupPolicy) (result *v1alpha.ArangoBackupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(arangobackuppoliciesResource, c.ns, arangoBackupPolicy), &v1alpha.ArangoBackupPolicy{})
...
func (c *FakeArangoBackupPolicies) Update(arangoBackupPolicy *v1alpha.ArangoBackupPolicy) (result *v1alpha.ArangoBackupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(arangobackuppoliciesResource, c.ns, arangoBackupPolicy), &v1alpha.ArangoBackupPolicy{})
...
func (c *FakeArangoBackupPolicies) UpdateStatus(arangoBackupPolicy *v1alpha.ArangoBackupPolicy) (*v1alpha.ArangoBackupPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(arangobackuppoliciesResource, "status", c.ns, arangoBackupPolicy), &v1alpha.ArangoBackupPolicy{})
...
func (c *FakeArangoBackupPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(arangobackuppoliciesResource, c.ns, name), &v1alpha.ArangoBackupPolicy{})
...
func (c *FakeArangoBackupPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha.ArangoBackupPolicyList{})
	return err
}

// Patch applies the patch and returns the patched arangoBackupPolicy.
func (c *FakeArangoBackupPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha.ArangoBackupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(arangobackuppoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha.ArangoBackupPolicy{})
