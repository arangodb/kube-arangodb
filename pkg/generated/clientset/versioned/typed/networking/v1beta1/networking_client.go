...
// NetworkingV1beta1Client is used to interact with features provided by the networking.arangodb.com group.
type NetworkingV1beta1Client struct {
	restClient rest.Interface
}

func (c *NetworkingV1beta1Client) ArangoRoutes(namespace string) ArangoRouteInterface {
