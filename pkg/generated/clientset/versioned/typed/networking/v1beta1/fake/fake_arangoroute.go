...
var arangoroutesResource = v1beta1.SchemeGroupVersion.WithResource("arangoroutes")

var arangoroutesKind = v1beta1.SchemeGroupVersion.WithKind("ArangoRoute")

// Get takes name of the arangoRoute, and returns the corresponding arangoRoute object, and an error if there is any.
func (c *FakeArangoRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ArangoRoute, err error) {
	emptyResult := &v1beta1.ArangoRoute{}
	obj, err := c.Fake.
	...
	return obj.(*v1beta1.ArangoRoute), err
}

// List takes label and field selectors, and returns the list of ArangoRoutes that match those selectors.
func (c *FakeArangoRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ArangoRouteList, err error) {
	emptyResult := &v1beta1.ArangoRouteList{}
	obj, err := c.Fake.
	...
	list := &v1beta1.ArangoRouteList{ListMeta: obj.(*v1beta1.ArangoRouteList).ListMeta}
	for _, item := range obj.(*v1beta1.ArangoRouteList).Items {
...
func (c *FakeArangoRoutes) Create(ctx context.Context, arangoRoute *v1beta1.ArangoRoute, opts v1.CreateOptions) (result *v1beta1.ArangoRoute, err error) {
	emptyResult := &v1beta1.ArangoRoute{}
	obj, err := c.Fake.
...
func (c *FakeArangoRoutes) Update(ctx context.Context, arangoRoute *v1beta1.ArangoRoute, opts v1.UpdateOptions) (result *v1beta1.ArangoRoute, err error) {
	emptyResult := &v1beta1.ArangoRoute{}
	obj, err := c.Fake.
...
func (c *FakeArangoRoutes) UpdateStatus(ctx context.Context, arangoRoute *v1beta1.ArangoRoute, opts v1.UpdateOptions) (result *v1beta1.ArangoRoute, err error) {
	emptyResult := &v1beta1.ArangoRoute{}
	obj, err := c.Fake.
...
func (c *FakeArangoRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(arangoroutesResource, c.ns, name, opts), &v1beta1.ArangoRoute{})
...
func (c *FakeArangoRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.ArangoRouteList{})
	return err
}

// Patch applies the patch and returns the patched arangoRoute.
func (c *FakeArangoRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ArangoRoute, err error) {
	emptyResult := &v1beta1.ArangoRoute{}
	obj, err := c.Fake.
