...
var arangoprofilesResource = v1beta1.SchemeGroupVersion.WithResource("arangoprofiles")

var arangoprofilesKind = v1beta1.SchemeGroupVersion.WithKind("ArangoProfile")
...
func (c *FakeArangoProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ArangoProfileList, err error) {
	...
	list := &v1beta1.ArangoProfileList{ListMeta: obj.(*v1beta1.ArangoProfileList).ListMeta}
	for _, item := range obj.(*v1beta1.ArangoProfileList).Items {
...
func (c *FakeArangoProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(arangoprofilesResource, c.ns, name, opts), &v1beta1.ArangoProfile{})
