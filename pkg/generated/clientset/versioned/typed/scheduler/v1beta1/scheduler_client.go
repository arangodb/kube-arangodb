...
type SchedulerV1beta1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*SchedulerV1beta1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new SchedulerV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SchedulerV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &SchedulerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new SchedulerV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *SchedulerV1beta1Client {
...
// New creates a new SchedulerV1beta1Client for the given RESTClient.
func New(c rest.Interface) *SchedulerV1beta1Client {
	return &SchedulerV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := schedulerv1beta1.SchemeGroupVersion
...
func (c *SchedulerV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
