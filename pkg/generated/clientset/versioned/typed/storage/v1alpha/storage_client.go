...
type StorageV1alphaInterface interface {
	RESTClient() rest.Interface
	ArangoLocalStoragesGetter
}
...
func NewForConfig(c *rest.Config) (*StorageV1alphaClient, error) {
	...
	return &StorageV1alphaClient{client}, nil
}

// NewForConfigOrDie creates a new StorageV1alphaClient for the given config and
