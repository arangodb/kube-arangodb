...
type ArangoMLStorageInformer interface {
	...
	Lister() mlv1alpha1.ArangoMLStorageLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MlV1alpha1().ArangoMLStorages(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlV1alpha1().ArangoMLStorages(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlV1alpha1().ArangoMLStorages(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlV1alpha1().ArangoMLStorages(namespace).Watch(ctx, options)
			},
		},
		&apismlv1alpha1.ArangoMLStorage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *arangoMLStorageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismlv1alpha1.ArangoMLStorage{}, f.defaultInformer)
}

func (f *arangoMLStorageInformer) Lister() mlv1alpha1.ArangoMLStorageLister {
	return mlv1alpha1.NewArangoMLStorageLister(f.Informer().GetIndexer())
}
