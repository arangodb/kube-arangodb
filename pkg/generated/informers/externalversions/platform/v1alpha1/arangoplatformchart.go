...
func NewFilteredArangoPlatformChartInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&platformv1alpha1.ArangoPlatformChart{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *arangoPlatformChartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1alpha1.ArangoPlatformChart{}, f.defaultInformer)
}

func (f *arangoPlatformChartInformer) Lister() v1alpha1.ArangoPlatformChartLister {
	return v1alpha1.NewArangoPlatformChartLister(f.Informer().GetIndexer())
}
