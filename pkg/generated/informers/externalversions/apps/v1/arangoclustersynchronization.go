	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().ArangoClusterSynchronizations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().ArangoClusterSynchronizations(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1.ArangoClusterSynchronization{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *arangoClusterSynchronizationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.ArangoClusterSynchronization{}, f.defaultInformer)
}
