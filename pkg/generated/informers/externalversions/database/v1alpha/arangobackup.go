...
import (
	...
	databasev1alpha "github.com/arangodb/kube-arangodb/pkg/apis/database/v1alpha"
	versioned "github.com/arangodb/kube-arangodb/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/arangodb/kube-arangodb/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha "github.com/arangodb/kube-arangodb/pkg/generated/listers/database/v1alpha"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatabaseV1alpha().ArangoBackups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatabaseV1alpha().ArangoBackups(namespace).Watch(options)
			},
		},
		&databasev1alpha.ArangoBackup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *arangoBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&databasev1alpha.ArangoBackup{}, f.defaultInformer)
}
