...
func (h *handler) Handle(ctx context.Context, item operation.Item) error {
	...
	object, err := util.WithKubernetesContextTimeoutP2A2(ctx, h.client.PermissionV1alpha1().ArangoPermissionRoles(item.Namespace).Get, item.Name, meta.GetOptions{})
	if err != nil {
	...
	if object.GetDeletionTimestamp() != nil {
		...
		if finalizer != "" {
			if changed, err := patcher.EnsureFinalizersGone(ctx, h.client.PermissionV1alpha1().ArangoPermissionRoles(item.Namespace), object, finalizer); err != nil {
				return err
			} else if changed {
	...
	if _, err := operator.WithArangoPermissionRoleUpdateStatusInterfaceRetry(context.Background(), h.client.PermissionV1alpha1().ArangoPermissionRoles(object.GetNamespace()), object, *status, meta.UpdateOptions{}); err != nil {
		return err
	}
...
func (h *handler) finalizer(ctx context.Context, extension *permissionApi.ArangoPermissionRole) (string, error) {
...
func (h *handler) handle(ctx context.Context, item operation.Item, extension *permissionApi.ArangoPermissionRole, status *permissionApi.ArangoPermissionRoleStatus) (bool, error) {
...
func (h *handler) HandleSpecValidity(ctx context.Context, item operation.Item, extension *permissionApi.ArangoPermissionRole, status *permissionApi.ArangoPermissionRoleStatus) (bool, error) {
...
func (h *handler) HandleDeployment(ctx context.Context, item operation.Item, extension *permissionApi.ArangoPermissionRole, status *permissionApi.ArangoPermissionRoleStatus) (bool, error) {
...
func (h *handler) HandleDeploymentSidecarConnection(ctx context.Context, item operation.Item, extension *permissionApi.ArangoPermissionRole, status *permissionApi.ArangoPermissionRoleStatus, depl *api.ArangoDeployment) (bool, error) {
