...
func Kind() string {
	return permission.ArangoPermissionPolicyRoleBindingResourceKind
}

func Group() string {
	return permissionApi.SchemeGroupVersion.Group
}

func Version() string {
	return permissionApi.SchemeGroupVersion.Version
}
