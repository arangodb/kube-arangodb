...
const (
	...
	SecretKeyMasterClientID     = "master-client-id"     // Key inside a Secret used to hold a JWT or monitoring token
	SecretKeyMasterClientSecret = "master-client-secret" // Key inside a Secret used to hold a JWT or monitoring token
