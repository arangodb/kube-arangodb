					...
					Containers: []core.Container{
						{
							...
							Env: []core.EnvVar{
								k8sutil.CreateEnvSecretKeySelector(utilConstants.EnvArangoSyncMonitoringToken,
									testDeploymentName+"-sync-mt", utilConstants.SecretKeyToken),
								k8sutil.CreateEnvFieldPath(utilConstants.EnvOperatorPodName, "metadata.name"),
								k8sutil.CreateEnvFieldPath(utilConstants.EnvOperatorPodNamespace, "metadata.namespace"),
								k8sutil.CreateEnvFieldPath(utilConstants.EnvOperatorNodeName, "spec.nodeName"),
								k8sutil.CreateEnvFieldPath(utilConstants.EnvOperatorNodeNameArango, "spec.nodeName"),
							},
