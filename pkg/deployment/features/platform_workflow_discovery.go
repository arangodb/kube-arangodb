...
var platformWorkflowDiscovery = &feature{
	...
	description:      "Defines if the operator discovers existing platform service Helm releases by label and creates a chart-less ArangoPlatformWorkflow for each",
