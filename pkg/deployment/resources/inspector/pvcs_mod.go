...
func (p persistentVolumeClaimsMod) V1() persistentvolumeclaimv1.ModInterface {
	return wrapMod[*core.PersistentVolumeClaim](definitions.Endpoints, p.i.GetThrottles, generic.WithModStatusGetter[*core.PersistentVolumeClaim](constants.PersistentVolumeClaimGKv1(), p.clientv1))
}
