...
func renderAndPrintGatewayConfig(t *testing.T, cfg GatewayConfig) *bootstrapAPI.Bootstrap {
...
func Test_GatewayConfig(t *testing.T) {
	t.Run("Default", func(t *testing.T) {
		renderAndPrintGatewayConfig(t, GatewayConfig{
