...
func (r *Reconciler) createSyncPlan(ctx context.Context, apiObject k8sutil.APIObject,
	...
	if spec.Sync.IsEnabled() {
		...
		return api.Plan{sharedReconcile.UpdateConditionActionV2("Sync Enabled", api.ConditionTypeSyncEnabled, true, "Sync enabled", "", "")}
	}
	...
	if cache.ArangoSync.Error == nil {
		if !cache.ArangoSync.IsSyncInProgress() {
			// Remove condition
			return api.Plan{sharedReconcile.RemoveConditionActionV2("Sync Disabled", api.ConditionTypeSyncEnabled)}
		}
	}
