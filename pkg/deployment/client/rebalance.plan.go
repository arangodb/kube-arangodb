...
func (c *client) RebalancePlan(ctx context.Context, request *RebalancePlanRequest) (RebalancePlanResponse, error) {
	...
	return arangod.PostRequest[*RebalancePlanRequest, RebalancePlanResponse](ctx, c.c, request, "_admin", "cluster", "rebalance", "execute").AcceptCode(goHttp.StatusOK).Response()
}
