...
func (c *client) GetTLS(ctx context.Context) (TLSDetails, error) {
	return arangod.GetRequest[TLSDetails](ctx, c.c, "_admin", "server", "tls").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}

func (c *client) RefreshTLS(ctx context.Context) (TLSDetails, error) {
	return arangod.PostRequest[any, TLSDetails](ctx, c.c, nil, "_admin", "server", "tls").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}

func (c *client) GetEncryption(ctx context.Context) (EncryptionDetails, error) {
	return arangod.GetRequest[EncryptionDetails](ctx, c.c, "_admin", "server", "encryption").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}

func (c *client) RefreshEncryption(ctx context.Context) (EncryptionDetails, error) {
	return arangod.PostRequest[any, EncryptionDetails](ctx, c.c, nil, "_admin", "server", "encryption").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}

func (c *client) GetJWT(ctx context.Context) (JWTDetails, error) {
	return arangod.GetRequest[JWTDetails](ctx, c.c, "_admin", "server", "jwt").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}

func (c *client) RefreshJWT(ctx context.Context) (JWTDetails, error) {
	return arangod.PostRequest[any, JWTDetails](ctx, c.c, nil, "_admin", "server", "jwt").Do(ctx).AcceptCode(goHttp.StatusOK).Response()
}
