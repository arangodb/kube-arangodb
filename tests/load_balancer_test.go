...
func TestLoadBalancerCursor(t *testing.T) {
	func runCursorLoadBalancingTest(t *testing.T, useVst bool) {
	...
	// run with VST
	runCursorLoadBalancingTest(t, true)

	// run with HTTP
	runCursorLoadBalancingTest(t, false)
}
